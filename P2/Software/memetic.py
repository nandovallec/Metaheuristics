...
if uni_cross:
    ...
    name_file = ("memetic_"+mode+"_"+dataset_name+"_"+str(restr_level)+"_seed_"+str(seed_asigned)+"_two_BestFirst")
else:
    name_file = ("memetic_"+mode+"_"+dataset_name+"_"+str(restr_level)+"_seed_"+str(seed_asigned)+"_two_BestLast")
